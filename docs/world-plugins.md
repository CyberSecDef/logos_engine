...
| --- | --- |
| `plugin-define` | `tileId`, `definition`, `migration: preserve/reset`. Install or replace a versioned program. |
...
and uses the new defaults. Neither option resets emitted world properties.
