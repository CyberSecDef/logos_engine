...
2. **5f2 — contact transmission:** implemented with separate reviewed activation,
   frozen daily presence, bounded case counts, visitor/home attribution and
   internal transit mixing. See the [contact rules](disease.md#daily-contact-spread--phase-5f2).
