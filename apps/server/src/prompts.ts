...
export class PromptService {
 ...
 private accept(world:World,job:PromptJob,raw:unknown) {
  ...
  for(const op of reply.operations) {
   ...
   if((op.kind==='faction-define'||op.kind==='faction-remove'||op.kind==='faction-relation')&&job.request.scope!=='world')throw Error('Faction registry changes require Entire world scope');
