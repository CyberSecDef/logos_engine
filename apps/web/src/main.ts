...
function promptState(id:string|null) {
 ...
 for(const name of ['chat-discuss','chat-propose','chat-export','chat-close','worlds-toggle','play','step','water-explain','food-trade-enable','food-trade-permission','soil-enable','settlement-create','settlement-food','rain-change','elevation-change','temperature-change','temperature-reset','communication-change'])$<HTMLButtonElement>(name).disabled=!!id;
