...
export const SettlementDaySchema=z.object({
 ...
 garrisonWorkers:count(1000000).optional(),researchWorkers:count(1000000).optional(),technologyPermille:count(2000).optional(),illWorkers:count(Number.MAX_SAFE_INTEGER).optional(),waterQualityPermille:count(1000).optional(),workers:count(Number.MAX_SAFE_INTEGER).optional(),visitorsAway:count(Number.MAX_SAFE_INTEGER).optional(),visitingWorkers:count(Number.MAX_SAFE_INTEGER).optional(),fertilityPermille:count(1000).optional(),potential:count(10_000_000),temperaturePermille:count(1000),moisturePermille:count(1000),land:z.boolean(),flooded:z.boolean(),
}).strict();
