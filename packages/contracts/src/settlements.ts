...
export const SettlementDaySchema=z.object({
 ...
 fertilityPermille:count(1000).optional(),potential:count(10_000_000),temperaturePermille:count(1000),moisturePermille:count(1000),land:z.boolean(),flooded:z.boolean(),
}).strict();
